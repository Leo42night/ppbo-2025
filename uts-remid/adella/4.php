...
class Produk {
    ...
    public function tampilkanInfo() {
        $formatHarga = number_format($this->harga, 0, ",", ".");
        return $formatHarga;
    }
}
...
class Buku extends Produk {
    ...
    public function tampilkanInfo() {
        $formatHarga = number_format($this->getHarga(), 0, ",", ".");
        return "Buku: {$this->getNama()}, Penulis: {$this->penulis}, Harga: {$formatHarga}";
    }
}
...
class Elektronik extends Produk {
    ...
    public function tampilkanInfo() {
        $formatHarga = number_format($this->getHarga(), 0, ",", ".");
        return "Elektronik:  " . $this->getNama() . ", Harga Spesial " . $formatHarga;
    }
}
