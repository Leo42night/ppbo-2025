...
class Produk {
    ...
    public function tampilkanInfo() {
        ...
        return "Produk: " . $this->nama . ", Harga: Rp " . $hargaFormat;
    }
}
...
class Buku extends Produk {  
    ...
    public function __construct($nama, $harga, $penulis) {
     ...
     function tampilkanInfo() {
        $hargaFormat = number_format($this->getHarga(), 0, ',', '.');  
        return "Buku: " . $this->getNama() . ", Penulis: " . $this->penulis . ", Harga: Rp " . $hargaFormat;
    }
}
...
class Elektronik extends Produk {  
    ...
    public function tampilkanInfo() {
        $hargaFormat = number_format($this->getHarga(), 0, ',', '.');  
        return "Elektronik: " . $this->getNama() . ", Harga Spesial: Rp " . $hargaFormat;
    }
}
