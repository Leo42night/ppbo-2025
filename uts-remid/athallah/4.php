...
class Produk {
    ...
    public function tampilkanInfo() {
        return "Produk: " . $this->nama . ", Harga: Rp " . number_format($this->harga);
    }
}
...
class Buku extends Produk {
    ...
    public function tampilkanInfo() {
        return "Buku: " . $this->nama . ", Penulis: " . $this->penulis . ", Harga: Rp " . number_format($this->harga, 0, ',', '.');
    }
}
...
class Elektronik extends Produk {
    ...
    public function tampilkanInfo() {
        return "Elektronik: " . $this->nama . ", Harga Spesial: Rp " . number_format($this->harga, 0, ',', '.');
    }
}
