...
class Reservasi {
    ...
    public function hitungTotalBiaya() {
        ...
        if ($this->kamar->tipeKamar == "mawar") {
            $harga *= 1.2;
        } elseif ($this->kamar->tipeKamar == "cantika") {
            $harga *= 1.5;
        }
...
$tamu1 = new Tamu("nayla", "T001");
$kamar1 = new Kamar(101, "mawar", 500000);
$reservasi1 = new Reservasi($tamu1, $kamar1, 3);
$reservasi1->tampilkanReservasi();

$tamu2 = new Tamu("dela", "T002");
$kamar2 = new Kamar(202, "cantika", 800000);
